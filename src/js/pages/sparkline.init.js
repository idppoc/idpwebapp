...
$(document).ready(function () {
    ...
    var DrawSparkline = function () {
        ...
        // Pie Chart
        var colors = ['#02c0ce', '#2d7bf4', '#e3eaef', '#f1556c'];
        ...
        // Tristate Charts
        var colors = ['#0acf97', '#e3eaef', '#f1556c'];
