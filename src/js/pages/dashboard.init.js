...
! function($) {
	"use strict";
		...
		//creates plot graph
		dashboard.prototype.createPlotGraph = function(selector, data1, data2, data3, labels, colors, borderColor, bgColor) {
			//shows tooltip
			...
			$.plot($(selector), [{
				...
				yaxis : {
					...
					tickColor : 'rgba(150, 150, 150, 0.1)',
					font : {
						color : '#8391a2'
					}
				},
		...
		//creates Donut Chart
		dashboard.prototype.createDonutGraph = function(selector, labels, datas, colors) {
			var data = [{
				label : labels[0],
				data : datas[0]
			}, {
		...
		dashboard.prototype.createCombineGraph = function(selector, ticks, labels, datas, colors) {
			var data = [{
				label : labels[0],
				data : datas[0],
				color : colors[0],
		...
		dashboard.prototype.init = function() {
			...
			var colors = ['#02c0ce','#2d7bf4','#f1556c'];
			var dataColors = $("#website-stats").data('colors');
			if (dataColors) {
				colors = dataColors.split(",");
			}
			var borderColor = 'rgba(150, 150, 150, 0.1)';
			var bgColor = 'transparent';
			this.createPlotGraph("#website-stats", uploads, downloads, downloads1, plabels, colors, borderColor, bgColor);
			...
			var colors = ['#e3eaef','#f1556c','#02c0ce'];
			...
			this.createDonutGraph("#donut-chart", donutlabels, donutdatas, donutcolors);

		},
  
		//init dashboard
		$.dashboard = new dashboard, $.dashboard.Constructor =
		dashboard
